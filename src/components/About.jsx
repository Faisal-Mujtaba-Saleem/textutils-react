...
export default function About() {
    ...
    const toggleDisplayMode = () => {
        if (displayModeStyle.color === 'black') {
            setDisplayModeStyle({
    ...
    return (
        <div className='container' style={displayModeStyle}>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item" >
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={displayModeStyle}>
            ...
            <div className="container">
                <button onClick={toggleDisplayMode} className="btn btn-primary my-3">{btnText}</button>
            </div>
        </div>
    )
}
